...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-e9a64ea0');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-e9a64ea0');}
...
function clearFlash(){dieView.classList.remove('rl-win-e9a64ea0');dieView.classList.remove('rl-lose-e9a64ea0');if(frameEl){frameEl.classList.remove('rl-win-e9a64ea0');frameEl.classList.remove('rl-lose-e9a64ea0');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-e9a64ea0');if(frameEl){frameEl.classList.add('rl-win-e9a64ea0');}}else{dieView.classList.add('rl-lose-e9a64ea0');if(frameEl){frameEl.classList.add('rl-lose-e9a64ea0');}}
...
var brandEl=document.querySelector('.rl-brand-e9a64ea0');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
